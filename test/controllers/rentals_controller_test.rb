...
class RentalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rental" do
    assert_difference('Rental.count') do
      post rentals_url, params: { rental: { daily_rate: @rental.daily_rate, name: @rental.name } }
    end
  ...
  test "should update rental" do
    patch rental_url(@rental), params: { rental: { daily_rate: @rental.daily_rate, name: @rental.name } }
